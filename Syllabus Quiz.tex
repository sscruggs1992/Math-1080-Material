...
%\end{center}
\newpage
%TODO -- Since you are not printing solutions, you can just put \vspace*{\stretch{1}} in place of the solutions environment. If this is so other instructors can use this template, disregard
\begin{questions}
...
%TODO -- Changed 'her' to 'their'. Gender neutral and consistent with previous question
\question Who is the course coordinator for Math 1080? What is their email address?
\begin{solution}[\stretch{1}]

\end{solution}

%TODO -- TBH - I don't know what you mean by this
%TODO -- Also, these summarize questions can be a bit vague and thus hard to grade
...
%TODO -- Make another T/F question asking about calculators on MLM
...
%TODO -- I know CIQ is defined in the syllabus, but do we think we should define it here as well?

%I think it give students an incentive to read the syllabus to know what CIQs are.
